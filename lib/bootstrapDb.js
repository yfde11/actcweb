...
async function fixCertificateAttemptIndex() {
    ...
    // 確保所有 certificates 索引存在（因 autoIndex:false）
    const indexNames = indexes.map((i) => i.name);
    if (!indexNames.includes('attempt_1')) {
